...
function News() {
  ...
  const ShortNews = SchoolNews.slice(0, 4);
  ...
  return (
    <div className="  py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8">{content[lang].news.heading}</h2>
        ...
        <div className="text-center mt-8">
          <NavLink
            className="inline-block bg-blue-600 text-white py-2 px-6 rounded-md font-medium hover:bg-blue-500 transition duration-300"
            to="/news"
            onClick={goToTop}
          >
